...
export function useCharacterJsonGeneration(characterInfoList, characterSkills, expansion, type = "baseCharacters"){
    let characterJson = {};
    switch (expansion) {
      case "Core":
        characterJson = {"Core": {} };
        break;
      case "Outcast":
        characterJson = {"Outcast": {} };
        break;
      case "Revenant":
        characterJson = {"Revenant": {} };
        break;
    ...
    characterInfoList.forEach(characterInfo => {
      ...
      currentJson = {
        ...
        characterState:[
          ...
          {name: "concentrado", icon: {text:"_focused", x:0.09533, y:0.09095}, active: false, color1: "210, 179, 26", color2: "233, 233, 42", positionX: 0.10533, positionY: 0.0944, positionXBlur: 7, positionYBlur: 0, angle:180},
        ...
        "slots":{
          "0":{"name":"equipment",
              "items":[
                  {slotId: 1, typeSlot:1, asociatedId: characterInfo.arm1_id, slot: { type: "svg", code: "mano"}},
                  {slotId: 2, typeSlot:1, asociatedId: characterInfo.arm2_id, slot: { type: "svg", code: "mano"}},
                  {slotId: 3, typeSlot:3, asociatedId: characterInfo.head_id, slot: { type: "svg", code: "casco"}},
                  {slotId: 4, typeSlot:4, asociatedId: characterInfo.chest_id, slot: { type: "svg", code: "pecho"}},
                  {slotId: 5, typeSlot:6, asociatedId: characterInfo.extra1_id, slot: { type: "svg", code: "equipo"}},
                  {slotId: 6, typeSlot:6, asociatedId: characterInfo.extra2_id, slot: { type: "svg", code: "equipo"}},
                  {slotId: 7, typeSlot:6, asociatedId: characterInfo.automedKit_id, slot: { type: "svg", code: "equipo"}}
              ]
          },
          1:{name:"software",
            items:[]
      ...
      characterJson[expansion][characterInfo.id] = currentJson;
    });
